          ...
          <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
                ...
                <a 
                  href="https://www.instagram.com/harborcafe.bucuresti/" target="_blank" rel="noopener noreferrer" 
                  style={{ fontFamily: 'var(--font-dm-sans)', fontSize: '0.75rem', color: 'rgba(245,239,230,0.65)', textDecoration: 'none', transition: 'color 0.2s ease' }}
                  onMouseEnter={(e) => (e.currentTarget.style.color = c.caramelLight)}
                  onMouseLeave={(e) => (e.currentTarget.style.color = 'rgba(245,239,230,0.65)')}
                >Instagram</a>
...
{/* Buton Instagram Plutitor */}
      <a 
        ...
        href="https://www.instagram.com/harborcafe.bucuresti/" 
        target="_blank" 
        rel="noopener noreferrer"
        style={{
          position: 'fixed',
          bottom: '20px',
          right: '20px',
          /* Gradientul oficial Instagram */
          background: 'radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf592 5%, #fd5949 45%, #d6249f 60%, #285AEB 90%)',
          color: 'white',
          width: '60px',
          height: '60px',
          borderRadius: '50%',
